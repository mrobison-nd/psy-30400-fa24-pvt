...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'practiceWaitTimes.xlsx', 'path': 'practiceWaitTimes.xlsx'},
    {'name': 'waitTimes.xlsx', 'path': 'waitTimes.xlsx'},
  ]
});
...
async function experimentInit() {
  ...
  text_7 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_7',
    text: 'We will start with a few practice trials. Remember: press SPACE as quickly as you can when you notice the timer start.\n\nPress the spacebar to begin...',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], draggable: false, height: 0.02,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
  ...
  text_8 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_8',
    text: 'That is the end of the practice trials.\n\nThe real task will now start. The task will go for about 12 minutes.\n\nPress the spacebar to begin...',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], draggable: false, height: 0.02,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
...
function instructions_2RoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_2Components.push(text_7);
...
function trials_2LoopBegin(trials_2LoopScheduler, snapshot) {
  return async function() {
    ...
    trials_2 = new TrialHandler({
      ...
      trialList: 'practiceWaitTimes.xlsx',
...
function instructions_3RoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_3Components.push(text_8);
...
function end_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of which components have finished
    end_taskComponents = [];
    end_taskComponents.push(text_9);
